...
func TestNew(t *testing.T) {
	t.Run("panics with labels overriding const labels", func(t *testing.T) {
		...
		assertError(t, `variableLabelNames should not include any of ConstLabels names, got variableLabelNames [some_label] including some_label defined in ConstLabels [some_label]`, panicked)
	})
}
